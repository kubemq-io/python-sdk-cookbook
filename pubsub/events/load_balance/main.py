...
if __name__ == "__main__":
    ...
    try:
        ...
        subscribe_request_a = create_subscribe_request(SubscribeType.Events,
                                                       'python-sdk-cookbook-pubsub-events-load-balance-receiver-a',
                                                       EventsStoreType.Undefined, 0, channel, group_name)
        ...
        subscribe_request_b = create_subscribe_request(SubscribeType.Events,
                                                       'python-sdk-cookbook-pubsub-events-load-balance-receiver-b',
                                                       EventsStoreType.Undefined, 0, channel, group_name)
        ...
        subscribe_request_c = create_subscribe_request(SubscribeType.Events,
                                                       'python-sdk-cookbook-pubsub-events-load-balance-v',
                                                       EventsStoreType.Undefined, 0, channel, group_name)
    ...
    for i in range(limit):
        event = Event(
            ...
            store=False,
            channel=channel,
            client_id="python-sdk-cookbook-pubsub-events-load-balance-sender"
        )
        event.tags = [
            ('key', 'value'),
            ('key2', 'value2'),
