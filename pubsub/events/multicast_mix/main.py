...
if __name__ == "__main__":
    ...
    queue = MessageQueue("q1;events:e1", "python-sdk-cookbook-events-multicast-mix-client",
                         "localhost:50000")
    ...
    queue_a = MessageQueue('q1', "python-sdk-cookbook-events-multicast-mix-client-receiver-A", "localhost:50000",
                           2, 1)
    try:
